...
* Both the `TextPost` and `TextArtPost` classes extend abstract class `Post` and implement interface `PostContentFormatter`. Their relation is shown in the following UML diagram.
<p align="center">
